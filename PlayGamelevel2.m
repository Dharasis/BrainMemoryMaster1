...
//    scoreLab.font=[UIFont systemFontOfSize:20];
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    UILabel *scoreLab=[[UILabel alloc]init];
    if ((width1>=375)&&(height1>=667)) {
        scoreLab.frame=CGRectMake(20,0,width1-30,40);
    }
    else{
        scoreLab.frame=CGRectMake(20,0,width1-30,40);
    }
    ...
    scoreLab.font=[UIFont systemFontOfSize:width1/18];
    
    scoreLab.text=score;
    [lifeView addSubview:scoreLab];
    
    
    
    UILabel *highScore=[[UILabel alloc]init];
    if(width1==375&&height1==667 ){
        highScore.frame=CGRectMake(width1-125,0,width1/2-30,40);
    }
    else if(width1>=414&&height1>=736){
        highScore.frame=CGRectMake(width1-135,0,width1,40);
    }
    else{
        highScore.frame=CGRectMake(width1-110,0,width1,40);
    }
    ...
    NSInteger storedScore = [[NSUserDefaults standardUserDefaults] integerForKey:@"highScore2"];    NSLog(@"stored score===%ld",(long)[[NSUserDefaults standardUserDefaults] integerForKey:@"highScore1"]);
