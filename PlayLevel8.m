...
-(void)viewWillAppear:(BOOL)animated{
  ...
  NSInteger storedScore = [[NSUserDefaults standardUserDefaults] integerForKey:@"highScore8"];
...
-(void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if(buttonIndex==0)
    {
        ScoreViewController *s8=[[ScoreViewController alloc]init];
